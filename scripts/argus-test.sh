...
FIELD: Start Date
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Start Date'||t.startsWith('Start Date ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Start Date';})()
...
FIELD: Annual Salary
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Annual Salary'||t.startsWith('Annual Salary ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Annual Salary';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Annual Salary

FIELD: Notice Period
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Notice Period'||t.startsWith('Notice Period ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Notice Period';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Notice Period

FIELD: Probation Period
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Probation Period'||t.startsWith('Probation Period ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Probation Period';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Probation Period

FIELD: Nationality
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Nationality'||t.startsWith('Nationality ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Nationality';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Nationality

FIELD: Job Location
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Job Location'||t.startsWith('Job Location ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Job Location';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Job Location

FIELD: Work Schedule
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Work Schedule'||t.startsWith('Work Schedule ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Work Schedule';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
  Record result for: Work Schedule

FIELD: Holidays
  Step A - browser_console: (function(){var el=[...document.querySelectorAll('*')].filter(function(e){var t=e.textContent.trim();return t==='Holidays'||t.startsWith('Holidays ');}).pop();var row=el;for(var i=0;i<6&&row;i++){if(row.querySelector('vaadin-icon,svg')){row.dispatchEvent(new MouseEvent('click',{bubbles:true,cancelable:true,view:window}));return 'clicked:'+row.tagName+':'+row.textContent.trim().substring(0,30);}row=row.parentElement;}return 'not found:Holidays';})()
  Step B - terminal sleep 2
  Step C - browser_console: (function(){var q=[document],r=[];while(q.length){var n=q.shift();try{n.querySelectorAll('vaadin-text-field,vaadin-date-picker,vaadin-combo-box,vaadin-number-field,vaadin-select,vaadin-text-area,vaadin-integer-field').forEach(function(e){r.push(e.tagName.toLowerCase()+':'+(e.getAttribute('label')||''));});n.querySelectorAll('*').forEach(function(e){if(e.shadowRoot)q.push(e.shadowRoot);});}catch(x){}}return JSON.stringify(r);})()
