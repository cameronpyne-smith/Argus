...
7. RECORD each confirmed bug immediately, while it is still on screen — all three steps below, before you click, navigate, or move to the next check. No exceptions, and never batch bugs to write later:
